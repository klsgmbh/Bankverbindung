   ...
   <out:template match="/*">
      <out:copy>
         ...
         <out:for-each select="F00000013">
            <out:copy>
               <out:attribute name="ifp:label">Familienname</out:attribute>
         ...
         <out:for-each select="bank">
            <out:copy>
               <out:attribute name="ifp:label">Name und Sitz der Bank</out:attribute>
               <out:attribute name="ifp:type">string</out:attribute>
               <out:value-of select="."/>
            </out:copy>
         </out:for-each>
         <out:for-each select="f00000106">
            <out:copy>
               <out:attribute name="ifp:label">F00000106:</out:attribute>
               <out:choose>
         ...
         <out:for-each select="f00000107">
            <out:copy>
               <out:attribute name="ifp:label">F00000107:</out:attribute>
               <out:choose>
                  <out:when test="@a:type='number'">
                     <out:attribute name="ifp:type">decimal</out:attribute>
                     <out:attribute name="xsi:type">xs:decimal</out:attribute>
